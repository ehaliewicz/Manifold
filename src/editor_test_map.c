...
static const s16 sectors[35] = {
    ...
    13, 12, 4, -80<<4, 216<<4, BLUE_BLACK_IDX, LIGHT_BLUE_IDX,
    18, 16, 4, -80<<4, 216<<4, BLUE_BLACK_IDX, LIGHT_BLUE_IDX,
    23, 20, 4, -80<<4, 216<<4, BLUE_BLACK_IDX, LIGHT_BLUE_IDX,
    28, 24, 4, -80<<4, 216<<4, BLUE_BLACK_IDX, LIGHT_BLUE_IDX,
};
