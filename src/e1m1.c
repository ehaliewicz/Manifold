...
const blockmap blockmp = {
       .x_origin = -776, .y_origin = -4872, 
       .num_columns = 36, .num_rows = 23, .num_offsets = 828,
       .offsets_plus_table = {828, 830, 832, 834, 836, 838, 840, 842, 844, 846, 848, 850, 852, 854, 856, 858, 860, 862, 864, 866, 868, 870, 872, 874, 876, 878, 880, 882, 884, 889, 896, 900, 902, 904, 906, 908,
