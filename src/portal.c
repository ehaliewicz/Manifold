...
static u32* vert_transform_cache;
...
void portal_rend(u16 src_sector, u32 cur_frame) {
    ...
    while(!queue_empty()) {
        ...
        for(int i = 0; i < num_walls; i++) {
            ...
            if(is_portal) {
                vis_query_result vis = is_visible(v1, v2, window_min, window_max);
                ...
                draw_wall_from_verts(v1, v2, ceil_height, floor_height, window_min, window_max);
            }
        }
        sector_visited_cache[sector]++;
    }
