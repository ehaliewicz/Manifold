...
/*
const u8 col_9_spans[2] = {34,5};
const u8 col_9_texels[5] = {0xcc,0xcc,0xcc,0xcc,0xff};
const u8 col_10_spans[2] = {32,8};
const u8 col_10_texels[8] = {0xcc,0xcc,0xcc,0xcc,0xff,0xff,0xff,0x88};
const u8 col_11_spans[2] = {31,10};
const u8 col_11_texels[10] = {0xcc,0xcc,0xcc,0xcc,0xff,0xaa,0xaa,0xff,0xff,0x22};
const u8 col_12_spans[2] = {30,11};
const u8 col_12_texels[11] = {0xcc,0x66,0x66,0x66,0xcc,0xff,0xff,0xff,0xff,0xff,0x22};
const u8 col_13_spans[2] = {30,11};
const u8 col_13_texels[11] = {0x66,0x22,0x22,0x66,0xcc,0xaa,0xff,0xff,0xaa,0xcc,0x88};
const u8 col_14_spans[2] = {29,12};
const u8 col_14_texels[12] = {0xff,0x22,0x22,0x66,0x66,0xcc,0xff,0xff,0xff,0xff,0xcc,0xff};
const u8 col_15_spans[2] = {28,13};
const u8 col_15_texels[13] = {0xcc,0xff,0x66,0x66,0xcc,0xcc,0xff,0xff,0xaa,0xaa,0xff,0xcc,0xff};
const u8 col_16_spans[2] = {27,13};
const u8 col_16_texels[13] = {0xcc,0xcc,0xff,0xcc,0xcc,0xcc,0xff,0xff,0xff,0xff,0xff,0xcc,0xff};
const u8 col_17_spans[4] = {21,5,1,15};
const u8 col_17_texels[20] = {0xcc,0xcc,0xff,0xff,0x88,0xcc,0xcc,0xff,0xff,0xff,0xff,0xcc,0x22,0x88,0xcc,0xff,0xff,0xff,0xff,0xff};
const u8 col_18_spans[4] = {20,14,8,1};
const u8 col_18_texels[15] = {0xcc,0xcc,0xcc,0xcc,0xff,0xcc,0x88,0xcc,0xff,0x22,0xff,0xcc,0xcc,0xff,0x66};
const u8 col_19_spans[4] = {8,22,12,1};
const u8 col_19_texels[23] = {0x66,0x33,0x33,0x66,0x33,0x66,0x66,0x66,0x66,0x66,0xcc,0xcc,0x22,0x66,0xcc,0xcc,0xcc,0xff,0xcc,0xff,0x88,0xff,0x66};
const u8 col_20_spans[4] = {7,22,13,1};
const u8 col_20_texels[23] = {0x66,0x22,0x22,0x22,0x33,0x22,0x33,0x66,0x22,0x66,0x66,0x66,0xcc,0x66,0x66,0xcc,0xcc,0xcc,0xff,0xff,0xff,0xcc,0x22};
const u8 col_21_spans[2] = {6,36};
const u8 col_21_texels[36] = {0x66,0x22,0x33,0x33,0x22,0x22,0x33,0x66,0x33,0x66,0x33,0x22,0x66,0xcc,0x66,0xcc,0xcc,0xdd,0xdd,0xdd,0xdd,0xcc,0xcc,0xff,0xff,0xff,0xff,0xff,0xff,0x88,0x88,0x66,0x66,0x22,0x22,0x22};   
const u8 col_22_spans[2] = {6,24};
const u8 col_22_texels[24] = {0x22,0x33,0x33,0x33,0x22,0x22,0x33,0x22,0x66,0x33,0x66,0x66,0xcc,0xcc,0xcc,0xcc,0xdd,0xdd,0xdd,0xdd,0xdd,0xdd,0xcc,0xcc};
const u8 col_23_spans[4] = {6,28,9,3};
const u8 col_23_texels[31] = {0x22,0x33,0x33,0x22,0x22,0x33,0x33,0x33,0x33,0x66,0x33,0x66,0xcc,0xcc,0xcc,0xdd,0xdd,0x11,0xdd,0xdd,0xdd,0xdd,0xdd,0xcc,0xff,0xcc,0xcc,0xff,0x77,0x77,0xff};
const u8 col_24_spans[8] = {6,29,2,5,1,3,4,5};
const u8 col_24_texels[42] = {0x66,0x22,0x22,0x22,0x33,0x22,0x33,0x33,0x33,0x22,0x33,0x66,0xcc,0xff,0xdd,0xdd,0x11,0xdd,0xcc,0x33,0xdd,0xdd,0xdd,0xcc,0xff,0x22,0x66,0xcc,0xff,0xff,0xff,0xff,0xff,0xff,0x77,0xff,0xff,0xcc,0x88,0x88,0x88,0xcc};
const u8 col_25_spans[4] = {7,39,2,9};
const u8 col_25_texels[48] = {0x66,0x22,0x33,0x33,0x33,0x33,0x33,0x33,0x33,0x66,0xcc,0xff,0xff,0xdd,0xdd,0x33,0xcc,0xdd,0x33,0xdd,0xdd,0xdd,0xcc,0xff,0xff,0xff,0xff,0xcc,0xff,0xcc,0xff,0xcc,0xff,0xff,0xff,0xff,0xff,0xff,0x77,0xcc,0x88,0x88,0x88,0x88,0x88,0x88,0x88,0xcc};
const u8 col_26_spans[6] = {7,1,1,37,1,12};
const u8 col_26_texels[50] = {0x44,0x66,0xdd,0xdd,0xdd,0xdd,0xdd,0xdd,0x66,0xff,0xff,0xdd,0xdd,0xdd,0x33,0xcc,0xdd,0xdd,0xdd,0xdd,0xdd,0xcc,0xcc,0xcc,0xcc,0xcc,0xff,0xff,0x66,0xff,0xcc,0xff,0xff,0xff,0xff,0xff,0x77,0x77,0xcc,0x88,0x88,0x22,0x22,0x22,0x22,0x88,0x88,0x88,0x88,0xcc};
const u8 col_27_spans[4] = {6,1,2,51};
const u8 col_27_texels[52] = {0x44,0xdd,0x11,0x11,0x11,0xdd,0xdd,0xdd,0xcc,0xdd,0xcc,0xdd,0xdd,0xcc,0xcc,0xcc,0xcc,0xcc,0x33,0xdd,0xcc,0xcc,0x66,0xcc,0xcc,0x66,0x33,0x22,0x22,0x66,0xcc,0x88,0xff,0xff,0xff,0x77,0x77,0xff,0xcc,0x88,0x22,0x22,0x22,0x22,0x22,0x22,0x22,0x22,0x22,0x88,0x88,0xcc};
const u8 col_28_spans[2] = {3,57};
const u8 col_28_texels[57] = {0x44,0x44,0x44,0x44,0x44,0xdd,0x11,0x33,0x33,0x11,0xdd,0xdd,0x66,0xcc,0x66,0xdd,0x88,0xdd,0xdd,0x11,0xcc,0xdd,0xdd,0xdd,0xcc,0xcc,0x66,0x22,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0x88,0xff,0xff,0x88,0x77,0xff,0xff,0x88,0x22,0x22,0x22,0x33,0x33,0x33,0x33,0x33,0x22,0x22,0x22,0x88,0x88};
const u8 col_29_spans[2] = {2,60};
const u8 col_29_texels[60] = {0x44,0xdd,0x77,0xdd,0x44,0x44,0x44,0x44,0x44,0x44,0x11,0x33,0x33,0xcc,0xcc,0xcc,0xdd,0x88,0x88,0xdd,0xdd,0xcc,0xdd,0xdd,0xff,0xff,0xff,0x22,0xcc,0xff,0xcc,0xff,0xcc,0xff,0xcc,0xff,0x22,0xff,0xff,0xff,0x22,0xff,0xff,0x77,0x88,0x22,0x33,0x33,0x33,0x33,0x33,0x33,0x33,0x33,0x22,0x22,0x22,0x22,0x88,0x88};
const u8 col_30_spans[2] = {3,59};
const u8 col_30_texels[59] = {0x44,0xdd,0x77,0x77,0x77,0xdd,0x44,0x44,0x44,0x11,0xdd,0xdd,0xcc,0xcc,0xcc,0xdd,0x88,0x88,0xdd,0xdd,0xcc,0xdd,0xdd,0xff,0xff,0xff,0x33,0xcc,0xff,0x66,0xff,0x22,0xff,0x66,0xff,0x22,0xff,0xff,0xff,0x22,0xff,0x77,0x77,0x88,0x22,0x33,0x33,0x33,0x33,0x33,0x33,0x33,0x33,0x22,0x22,0x22,0x22,0x88,0x88};
const u8 col_31_spans[2] = {3,57};
const u8 col_31_texels[57] = {0x44,0x44,0x44,0x44,0x44,0xdd,0x11,0x33,0x33,0x11,0xdd,0xdd,0x66,0xcc,0x66,0xdd,0x88,0xdd,0xdd,0x11,0xcc,0xdd,0xdd,0xdd,0xcc,0xcc,0x66,0x66,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0x88,0xff,0xff,0x88,0x77,0x77,0xff,0x88,0x22,0x22,0x22,0x33,0x33,0x33,0x33,0x33,0x22,0x22,0x22,0x88,0x88};
const u8 col_32_spans[6] = {4,1,1,1,2,51};
const u8 col_32_texels[53] = {0x44,0x44,0xdd,0x11,0x11,0x11,0xdd,0xdd,0xdd,0xcc,0xdd,0xcc,0xdd,0xdd,0x11,0x33,0xcc,0x33,0xdd,0xdd,0xdd,0xcc,0xcc,0x66,0xcc,0xcc,0x66,0x33,0x22,0x22,0x66,0xcc,0x88,0xff,0xff,0xff,0x77,0xff,0xff,0xcc,0x88,0x22,0x22,0x22,0x22,0x22,0x22,0x22,0x22,0x22,0x88,0x88,0xcc};
const u8 col_33_spans[6] = {3,1,6,36,1,12};
const u8 col_33_texels[49] = {0x44,0xdd,0xdd,0xdd,0xdd,0xdd,0xdd,0xcc,0xff,0xff,0xdd,0xdd,0xdd,0x33,0xdd,0xcc,0x33,0xdd,0xdd,0xdd,0xcc,0xcc,0xcc,0xcc,0xcc,0xff,0xff,0x66,0xff,0xcc,0xff,0xff,0xff,0xff,0xff,0xff,0x77,0xcc,0x88,0x88,0x22,0x22,0x22,0x22,0x88,0x88,0x88,0x88,0xcc};
const u8 col_34_spans[4] = {12,34,2,9};
const u8 col_34_texels[43] = {0xcc,0x22,0x66,0xcc,0xff,0xff,0xff,0xff,0xdd,0xdd,0x33,0x33,0xdd,0xcc,0xdd,0x33,0xdd,0xcc,0xff,0xff,0xff,0xff,0xcc,0xff,0xcc,0xff,0xcc,0xff,0xff,0xff,0xff,0xff,0x77,0x77,0xcc,0x88,0x88,0x88,0x88,0x88,0x88,0x88,0xcc};
const u8 col_35_spans[8] = {12,23,2,5,1,3,4,5};
const u8 col_35_texels[36] = {0xcc,0x66,0x22,0x66,0xcc,0xff,0xff,0xff,0xdd,0xdd,0x11,0x33,0x11,0xdd,0xdd,0x33,0xdd,0xcc,0xff,0x22,0x66,0xcc,0xff,0xff,0xff,0xff,0xff,0xff,0x77,0x77,0xff,0xcc,0x88,0x88,0x88,0xcc};   
const u8 col_36_spans[4] = {13,21,9,3};
const u8 col_36_texels[24] = {0xcc,0xcc,0xcc,0xcc,0xcc,0xcc,0xcc,0xcc,0xdd,0xdd,0x11,0xdd,0xdd,0xdd,0xdd,0xdd,0xcc,0xff,0xcc,0xcc,0xff,0x77,0xff,0xff};
const u8 col_37_spans[2] = {19,11};
const u8 col_37_texels[11] = {0xcc,0xcc,0xcc,0xdd,0xdd,0xdd,0xdd,0xdd,0xdd,0xcc,0xcc};
const u8 col_38_spans[2] = {19,10};
const u8 col_38_texels[10] = {0xcc,0x66,0xcc,0xcc,0xdd,0xdd,0xdd,0xdd,0xcc,0xcc};
const u8 col_39_spans[2] = {17,12};
const u8 col_39_texels[12] = {0x66,0xcc,0xcc,0x66,0x66,0xcc,0xcc,0xcc,0xff,0xff,0x88,0xff};
const u8 col_40_spans[2] = {15,16};
const u8 col_40_texels[16] = {0x66,0x22,0x22,0x66,0xcc,0x22,0x66,0xcc,0xcc,0xcc,0xff,0xcc,0xff,0x22,0xcc,0xff};
const u8 col_41_spans[4] = {20,13,7,2};
const u8 col_41_texels[15] = {0xcc,0xcc,0xcc,0xcc,0xff,0xcc,0x88,0xcc,0xff,0x88,0xff,0xff,0xff,0xff,0xff};
const u8 col_42_spans[6] = {19,7,1,7,5,4};
const u8 col_42_texels[18] = {0x66,0xcc,0xcc,0xcc,0xff,0xff,0x88,0xcc,0xcc,0xff,0xff,0xcc,0xff,0xff,0xff,0x66,0x88,0xff};
const u8 col_43_spans[6] = {19,2,6,8,3,6};
const u8 col_43_texels[16] = {0x22,0x66,0xcc,0xcc,0xff,0xcc,0xcc,0x88,0xff,0xff,0xff,0xcc,0xcc,0x66,0xcc,0xff};
const u8 col_44_spans[6] = {18,2,8,8,1,8};
const u8 col_44_texels[18] = {0x22,0x66,0xcc,0xff,0x66,0xcc,0x88,0x22,0xff,0xff,0xff,0xcc,0xcc,0xcc,0xff,0xff,0xcc,0xff};
const u8 col_45_spans[6] = {18,1,10,12,2,2};
const u8 col_45_texels[15] = {0x66,0x66,0x66,0x66,0xcc,0x88,0x22,0xff,0xff,0xff,0x22,0xcc,0xff,0xff,0xcc};
const u8 col_46_spans[4] = {29,11,4,1};
const u8 col_46_texels[12] = {0x66,0x22,0x66,0x66,0xcc,0x88,0xff,0xff,0x22,0xcc,0xff,0xff};
const u8 col_47_spans[2] = {29,11};
const u8 col_47_texels[11] = {0x66,0x33,0x66,0x66,0x66,0xff,0xff,0xff,0x33,0xcc,0xff};
const u8 col_48_spans[4] = {29,10,6,1};
const u8 col_48_texels[11] = {0x66,0x22,0x33,0x66,0xff,0x66,0xcc,0xff,0x22,0xff,0xcc};
const u8 col_49_spans[4] = {28,11,6,1};
const u8 col_49_texels[12] = {0x33,0x66,0x66,0x22,0xff,0x33,0x22,0x88,0xcc,0x66,0xff,0xcc};
const u8 col_50_spans[4] = {27,12,5,2};
const u8 col_50_texels[14] = {0x33,0x22,0x66,0x66,0x66,0xff,0x33,0x22,0x22,0x88,0xff,0xff,0xcc,0xff};
const u8 col_51_spans[4] = {26,14,2,3};
const u8 col_51_texels[17] = {0x33,0x22,0x66,0x33,0x66,0xcc,0xff,0x22,0x66,0x22,0x88,0x66,0xcc,0xff,0xff,0xcc,0xcc};
const u8 col_52_spans[4] = {25,6,1,13};
const u8 col_52_texels[19] = {0x33,0x33,0x22,0x33,0x66,0x33,0xff,0xcc,0xff,0x66,0x22,0x66,0x66,0xcc,0xcc,0xcc,0x66,0x66,0xcc};
const u8 col_53_spans[4] = {24,6,3,12};
const u8 col_53_texels[18] = {0x33,0x33,0x22,0x33,0x66,0x33,0xff,0xff,0x66,0x22,0x33,0x66,0x66,0x66,0x66,0x22,0x66,0xff};
const u8 col_54_spans[4] = {24,5,5,10};
const u8 col_54_texels[15] = {0x22,0x22,0x33,0x33,0x33,0xff,0xcc,0x66,0x22,0x33,0x33,0x22,0x22,0x66,0xcc};
const u8 col_55_spans[4] = {24,4,7,9};
const u8 col_55_texels[13] = {0x33,0x22,0x33,0x33,0xff,0xcc,0x66,0x22,0x22,0x22,0x66,0xcc,0xff};
const u8 col_56_spans[4] = {25,2,9,7};
const u8 col_56_texels[9] = {0x33,0x33,0xcc,0xcc,0xcc,0xcc,0xcc,0xcc,0xcc};
const u8 col_57_spans[2] = {37,5};
const u8 col_57_texels[5] = {0xff,0xcc,0xcc,0xcc,0xff};
