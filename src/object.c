...
const object_template object_types[32+1] = {
    ...
    {.is_player = 0, .name = "player_object_type", .type = OBJECT, .anchor_bot = 1, .anchor_top = 0,},
    ...
    .type = OBJECT},
    {.init_state = 0, .is_player = 0, .anchor_top = 0, . anchor_bot = 1},
    {.init_state = 0, .is_player = 0, .anchor_top = 0, . anchor_bot = 1},
    {.init_state = 0, .is_player = 0, .anchor_top = 0, . anchor_bot = 1},
    {.init_state = 0, .is_player = 0, .anchor_top = 0, . anchor_bot = 1},
    {.init_state = 0, .is_player = 0, .anchor_top = 0, . anchor_bot = 1},
    ...
    //{.init_state = 2,
    // .name = "blue keycard", 
    //.size = 20, .from_anchor_draw_offset = 10<<4, .width=30, .height=46<<4},
    //{.init_state = 1,
    // .name = "red cube",
    //.size = 20, .from_anchor_draw_offset = 20<<4, .width=12, .height=20<<4},
    //{.init_state = 1,
    // .name = "first enemy type ",
    //.size = 20, .from_anchor_draw_offset = 10<<4, .width=46, .height=80<<4},
};
